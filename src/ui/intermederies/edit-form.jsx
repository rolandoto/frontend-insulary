...
import {  updateIntermederies } from "../../lib/actions";
import { useActionState } from "react";
import { Toaster } from "sonner";
import { useSelector } from "react-redux";

export default function EditIntermederiesForm({ intermederies }) {
  const { accessToken} = useSelector(
    (state) => state.Refrestoken
  );  
    const initialState ={message:"",errors:{}};
    const updateWithId = updateIntermederies.bind(null,intermederies.id,accessToken);
  ...
  return (
      ...
      <div className="mb-4">
        ...
        <div className="relative mt-2 rounded-md">
          <input
            ...
            defaultValue={intermederies.nombre}
      ...
      <div className="mb-4">
        ...
        <div className="relative mt-2 rounded-md">
          <input
            ...
            defaultValue={intermederies.nit}
          />
          <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
        </div>
      ...
      <div className="mb-4">
        ...
        <div className="relative mt-2 rounded-md">
          <input
            ...
            defaultValue={intermederies.direccion}
          />
          <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
        </div>
      ...
      <div className="mb-4">
        ...
        <div className="relative mt-2 rounded-md">
          <input
            ...
            defaultValue={intermederies.tipo}
          />
          <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
        </div>
      ...
      <div className="mb-4">
        ...
        <div className="relative mt-2 rounded-md">
          <input
            ...
            defaultValue={intermederies.telefono}
          />
          <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
        </div>
      ...
      <div className="mb-4">
        ...
        <div className="relative mt-2 rounded-md">
          <input
            ...
            defaultValue={intermederies.email}
          />
          <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
        </div>
      </div>
    ...
    <div className="mt-6 flex justify-end gap-4">
      ...
      <Button type="submit">Actualizar Intermederios</Button>
    </div>
  </form>
  );
}
