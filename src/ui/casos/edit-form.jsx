...
export default function EditCasesForm({ cases }) {
  ...
  return (
    <form action={formAction}>
       ...
       <div className="mb-4">
          <label htmlFor="estadosCasos" className="mb-2 block text-sm font-medium">
          Estados
          </label>
          <div className="relative">
            <select
              ...
              name="estadosCasos"
              className="peer block w-full cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
              aria-describedby="estadosCasos-error"
          ...
          <div id="intermediary-error" aria-live="polite" aria-atomic="true">
            {message.errors?.estadosCasos &&
              message.errors.estadosCasos.map((error) => (
                <p className="mt-2 text-sm text-red-500" key={error}>
                  {error}
                </p>
              ))}
        ...
        <div className="mb-4 mt-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              defaultValue={cases.asegurado_nombres}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue={cases.asegurado_tipo_doc}
            >
              <option value="" disabled>
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              defaultValue={cases.asegurado_documento}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              aria-describedby="telefono-error"
                defaultValue={cases.asegurado_telefono}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
      ...
      <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              defaultValue={cases.asegurado_direccion}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              defaultValue={cases.asegurado_email}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
       ...
       <div className="mb-4 mt-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-1 placeholder:text-gray-500"
              aria-describedby="code-error"
              defaultValue={cases.tomador_nombres}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
          <div id="name-error" aria-live="polite" aria-atomic="true">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              className="peer block w-full cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
              aria-describedby="intermediary-error"
               defaultValue={cases.tomador_tipo_doc}
            >
              <option value="" disabled>
                Seleccione el Tipo de documento
              </option>
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-1 placeholder:text-gray-500"
              aria-describedby="Document-error"
              defaultValue={cases.tomador_documento}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
          <div id="Document-error" aria-live="polite" aria-atomic="true">
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-1 placeholder:text-gray-500"
              aria-describedby="telefono-error"
              defaultValue={cases.tomador_telefono}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
          <div id="telefono-error" aria-live="polite" aria-atomic="true">
      ...
      <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-1 placeholder:text-gray-500"
              aria-describedby="addres-error"
               defaultValue={cases.tomador_direccion}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
          <div id="addres-error" aria-live="polite" aria-atomic="true">
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-1 placeholder:text-gray-500"
              aria-describedby="correo-error"
                defaultValue={cases.tomador_email}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
          <div id="correo-error" aria-live="polite" aria-atomic="true">
       ...
       <div className="mb-4 mt-5">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              defaultValue={cases.relato_hechos}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
    ...
    <div className="mb-4 mt-5">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              defaultValue={cases.placa_asegurada}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
    ...
    <div className="mb-4 mt-5">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              defaultValue={cases.valor_reserva}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
    ...
    <div className="mb-4 mt-5">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              defaultValue={cases.valor_indemnizacion}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
        ...
        <div className="mb-4 mt-5">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              defaultValue={cases.nro_carpeta}
            />
            <CiUser className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
          </div>
